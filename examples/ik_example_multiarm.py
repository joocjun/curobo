...
## NOTE(SJ): 
## Step 1. Calculate the collision-free IK for the right arm. 
    ## TODO(SJ): Disable the self-collision for the left arm when doing this. Or place it somewhere in the back.  
## Step 2. Calculate the collision-free IK for the left arm. 
    ## TODO(SJ): How to fix the right arm configuration to the IK solution of the right arm?
